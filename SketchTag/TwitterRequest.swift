...
// This will request an array of tweets
...
//                        error: nil
                    do {
                        try propertyListResponse = NSJSONSerialization.JSONObjectWithData(jsonResponse, options: NSJSONReadingOptions.MutableLeaves)
                    } catch{
